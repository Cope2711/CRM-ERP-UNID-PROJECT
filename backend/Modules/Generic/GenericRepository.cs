    ...
    public interface IGenericRepository<T> where T : class
    {
        ...
        Task<List<T>> GetAllAsync<GetAllDto>(GetAllDto getAllDto, params Expression<Func<T, object>>[] includes);
    ...
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        public async Task<List<T>> GetAllAsync<GetAllDto>(GetAllDto getAllDto, params Expression<Func<T, object>>[] includes)
        {
            IQueryable<T> queryable = _dbSet.AsQueryable();
